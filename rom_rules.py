...
CALC_LOGIC = {
    ...
    # ── 颈部前屈 ─────────────────────────────────────────────────────
    ("neck_flexion", "center"): {
        "axis": "双肩中点 = (lm11.xyz + lm12.xyz) / 2，代表肩峰位置（量角器轴心）",
        "moving_arm": "向量 肩中点 → 双耳中点，即 (lm7+lm8)/2 - 肩中点，肩峰指向外耳道",
        "fixed_arm": "向量 肩中点 → 垂直向上参考点，即 肩中点 + [0, -1, 0]，沿肩峰垂线垂直向上（与地面垂直）",
        "formula": "arccos( dot(耳中点-肩中点, 垂直向上-肩中点) / (|耳中点-肩中点| × |垂直向上-肩中点|) )",
        "description": "以肩峰（双肩中点）为轴心，肩峰至外耳道连线为移动臂，通过肩峰的垂直线为固定臂，符合康复评定量角器法标准",
    },
...
ROM_DEFINITIONS = [
...

    {
        ...
        "side": "center",
        "rule": "轴=肩中点(lm11+lm12)/2 | moving_vec=耳中点-肩中点(肩峰→外耳道) | fixed_vec=肩中点垂直向上参考线(通过肩峰的垂线) | 临床=几何角",
        "normal_range": "0°~45°",
    },
